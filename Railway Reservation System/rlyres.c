...
void add_trains()
{
    ...
    FILE *fp=fopen("d:\\online c project file\\alltrains.dat","rb");
    if(fp==NULL)
    {
        fp=fopen("d:\\online c project file\\alltrains.dat","wb");
...
{
    FILE *fp=fopen("d:\\online c project file\\allbookings.dat","rb");
    if(fp==NULL)
        return 0;
    Passenger pr;
    int count=0;
...
int book_ticket(Passenger p)
{
    ...
    FILE *fp=fopen("d:\\online c project file\\allbookings.dat","ab");
    if(fp==NULL)
    {
        textcolor(LIGHTRED);
...
{
    int result;
    FILE *fp1=fopen("d:\\online c project file\\allbookings.dat","rb");
    if(fp1==NULL)
    {
        textcolor(LIGHTRED);
        printf("\n No bookings done yet!");
    ...
    FILE *fp2=fopen("d:\\online c project file\\temp.dat","wb");
    Passenger pr;
    int found=0;
    ...
    if(found==0)
    {
        remove("d:\\online c project file\\temp.dat");
    }
    else
    {
       result= remove("d:\\online c project file\\allbookings.dat");
       if(result!=0)
            return 2;
        result=rename("d:\\online c project file\\temp.dat","d:\\online c project file\\allbookings.dat");
        if(result!=0)
            return 2;
    }
    return found;
  ...
  int cancel_train(char* train_no)
{
    ...
    FILE *fp2=fopen("d:\\online c project file\\temp2.dat","wb");
    Passenger pr;
    ...
    if(found==0)
    {
        remove("d:\\online c project file\\temp2.dat");
    }
    else
    {
       result= remove("d:\\online c project file\\allbookings.dat");

        result=rename("d:\\online c project file\\temp2.dat","d:\\online c project file\\allbookings.dat");
...
/* int cancel_train(char* train_no)
{
    ...
    FILE *fp2=fopen("d:\\online c project file\\temp1.dat","wb");
    FILE *fp3=fopen("d:\\online c project file\\temp3.dat","wb");
    Train tr;
    Passenger pr;
    int found=0;
    int found1=0;
    ...
    if(found==0)
    {
        remove("d:\\online c project file\\temp1.dat");

    }
    else
    {
        result=remove("d:\\online c project file\\alltrains.dat");
        if(result!=0)
            return 2;
        result=rename("d:\\online c project file\\temp1.dat","d:\\online c project file\\alltrains.dat");
        if(result!=0)
            return 2;
    }
    while(fread(&pr,sizeof(pr),1,fp1)==1)
    ...
    fclose(fp3);
    if(found1==0)
        remove("d:\\online c project file\\temp3.dat");
    else{
        result=remove("d:\\online c project file\\allbookings.dat");
        if(result!=0)
            return 2;
        result=rename("d:\\online c project file\\temp3.dat","d:\\online c project file\\allbookings.dat");
        if(result!=0)
            return 2;
    }
    return found;
